...
{
    public static string ToFactorioString(this InventoryType inventoryType) => inventoryType switch
    {
    ...
    public static InventoryType ToInventoryType(this string value) => value?.ToLowerInvariant() switch
    {
